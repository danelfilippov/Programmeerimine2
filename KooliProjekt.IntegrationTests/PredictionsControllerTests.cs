...
namespace KooliProjekt.IntegrationTests
{
    ...
    public class PredictionsControllerTests : TestBase
    {
        ...
        {
            // Arrange
            var url = "/api/Predictions/List/?page=0&pageSize=0";

            // Act
            var response = await Client.GetFromJsonAsync<OperationResult<PagedResult<Prediction>>>(url);
        ...
        {
            // Arrange
            var url = "/api/Predictions/Get/?id=131";
