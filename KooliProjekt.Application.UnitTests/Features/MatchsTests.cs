...
namespace KooliProjekt.Application.UnitTests.Features
{
    public class MatchsTests : TestBase
    {
        ...
        {
            // Arrange
            var validator = new SaveMatchsCommandValidator(DbContext);
            var command = new SaveMatchsCommand { Id = 0, Title = title };
            ...
            Assert.Equal(nameof(SaveMatchsCommand.Title), result.Errors.First().PropertyName);
        }
        ...
        public void SaveValidator_should_return_true_when_title_is_valid()
        {
            // Arrange
            var validator = new SaveMatchsCommandValidator(DbContext);
            var command = new SaveMatchsCommand { Id = 0, Title = "Match 1" };
