...
namespace KooliProjekt.Application.UnitTests.Features
{
    public class UsersTests : TestBase
    {
        ...
        {
            // Arrange
            var validator = new SaveUsersCommandValidator(DbContext);
            var command = new SaveUsersCommand { Id = 0, Title = title };
            ...
            Assert.Equal(nameof(SaveUsersCommand.Title), result.Errors.First().PropertyName);
        }
        ...
        public void SaveValidator_should_return_true_when_title_is_valid()
        {
            // Arrange
            var validator = new SaveUsersCommandValidator(DbContext);
            var command = new SaveUsersCommand { Id = 0, Title = "User 1" };
