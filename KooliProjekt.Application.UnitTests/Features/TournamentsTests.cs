...
namespace KooliProjekt.Application.UnitTests.Features
{
    public class TournamentsTests : TestBase
    {
        ...
        {
            // Arrange
            var validator = new SaveTournamentsCommandValidator(DbContext);
            var command = new SaveTournamentsCommand { Id = 0, Title = title };
            ...
            Assert.Equal(nameof(SaveTournamentsCommand.Title), result.Errors.First().PropertyName);
        }
        ...
        public void SaveValidator_should_return_true_when_title_is_valid()
        {
            // Arrange
            var validator = new SaveTournamentsCommandValidator(DbContext);
            var command = new SaveTournamentsCommand { Id = 0, Title = "Tournament 1" };
